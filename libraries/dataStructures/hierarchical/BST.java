...
public class BST<E extends Comparable<E>> {
    ...
    public BST(E[] a) {
        /* TO BE COMPLETED */
        Sorting.mergeSort2(a); 
        root = buildBalanced(a, 0, a.length - 1);
    }
    ...
    protected NodeBST<E> buildBalanced(E[] a, int begin, int end) {
        ...
        int m = (begin + end)/2; 
        NodeBST<E>  newRoot = new NodeBST<E>(a[m]); 
        newRoot.left = buildBalanced(a, begin, m - 1); 
        newRoot.right = buildBalanced(a, m + 1, end);
