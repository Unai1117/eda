...
public class Term {
    ...
    public int hashCode() {
        ...
        int sizeN = this.word.length();// length of the word n
        for (int i = 0; i < sizeN; i++) {
            res = res * this.hashCodeBase + this.word.charAt(i);
        }
        this.hashValue = res;
        return res;
    }
    ...
    public boolean equals(Object other) {
        /* TO BE COMPLETED */
        Term aux = (Term) other;
        if (this.hashValue == aux.hashValue) {
            return this.word.equals(aux.word);
        }
        return false;
    }
